...
<div class="main-column">
	...
	<?php if ( bp_group_has_invites( bp_ajax_querystring( 'invite' ) . '&per_page=10' ) ) : ?>
		...
		<?php global $invites_template; ?>
			<li id="<?php bp_group_invite_item_id(); ?>">
				...
				<div class="action">
					<a class="button remove" href="<?php bp_group_invite_user_remove_invite_url(); ?>" id="<?php bp_group_invite_item_id(); ?>"><?php esc_html_e( 'Remove Invite', 'arcane' ); ?></a>
	...
	<?php else : ?>
		...
		<div id="message" class="info">
			<p><?php esc_html_e( 'Select friends to invite.', 'arcane' ); ?></p>
		</div>
...
<div class="submit">
	<input type="submit" name="submit" id="submit" value="<?php esc_html_e( 'Send Invites', 'arcane' ); ?>" />
</div>
