...
function zocker_pagination( $args = array() ) {
    
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'zocker' ),
        'next_string'     => esc_html__( '&raquo;', 'zocker' ),
        'before_output'   => '',
        'after_output'    => ''
    );
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'zocker_pagination_defaults', $defaults )
    );
