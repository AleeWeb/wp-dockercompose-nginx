...
// image default alt
if( !function_exists( 'zocker_img_default_alt' ) ){
	function zocker_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'zocker_img_tag' ) ){
	function zocker_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = zocker_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'zocker_anchor_tag' ) ){
	function zocker_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'zocker_heading_tag' ) ){
	function zocker_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'zocker_paragraph_tag' ) ){
	function zocker_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'zocker_span_tag' ) ){
	function zocker_span_tag( array $args ){
