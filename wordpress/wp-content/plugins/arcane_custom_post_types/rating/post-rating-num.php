...
<li><?php echo  esc_attr($rating_1_text); ?>
    <div class="progress">
      <div class="progress-bar  progress-bar10" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100">
        0.5/5
      </div>
    </div>
</li>
...
<li><?php echo  esc_attr($rating_1_text); ?>
    <div class="progress">
      <div class="progress-bar  progress-bar20" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
        1/5
      </div>
    </div>
</li>
...
<li><?php echo  esc_attr($rating_1_text); ?>
    <div class="progress">
      <div class="progress-bar  progress-bar30" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">
        1.5/5
      </div>
    </div>
</li>
...
<li><?php echo  esc_attr($rating_1_text); ?>
    <div class="progress">
      <div class="progress-bar  progress-bar40" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">
        2/5
      </div>
    </div>
</li>
...
<li><?php echo  esc_attr($rating_1_text); ?>
    <div class="progress">
      <div class="progress-bar  progress-bar50" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
        2.5/5
      </div>
    </div>
</li>
...
<li><?php echo  esc_attr($rating_1_text); ?>
    <div class="progress">
      <div class="progress-bar  progress-bar60" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
        3/5
      </div>
    </div>
</li>
...
<li><?php echo  esc_attr($rating_1_text); ?>
    <div class="progress">
      <div class="progress-bar  progress-bar70" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
        3.5/5
      </div>
    </div>
</li>
...
<li><?php echo  esc_attr($rating_1_text); ?>
    <div class="progress">
      <div class="progress-bar  progress-bar80" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" >
        4/5
      </div>
    </div>
</li>
...
<li><?php echo  esc_attr($rating_1_text); ?>
    <div class="progress">
      <div class="progress-bar  progress-bar90" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
        4.5/5
      </div>
    </div>
</li>
...
<li><?php echo  esc_attr($rating_1_text); ?>
    <div class="progress">
      <div class="progress-bar  progress-bar100" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
        5/5
      </div>
    </div>
</li>
