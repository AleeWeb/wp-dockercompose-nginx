...
function arcane_meta_box_cb( $post )
{
...
?>
<p>
<label for="my_meta_box_text"><b><?php esc_html_e("Over All Score", 'arcane') ?></b></label>
...
<p>
<label for="creteria_1"><b><?php esc_html_e("Critera 1", 'arcane') ?></b></label>
<input type="text" name="creteria_1_text" id="creteria_1_text" value="<?php echo esc_attr($creteria_1_text); ?>" />
</p>
<p>
<label for="creteria_1"><b><?php esc_html_e("Critera 1 Score", 'arcane') ?></b></label>
...
<p>
<label for="creteria_2"><b><?php esc_html_e("Critera 2", 'arcane') ?></b></label>
<input type="text" name="creteria_2_text" id="creteria_2_text" value="<?php echo esc_attr($creteria_2_text); ?>" />
</p>
<p>
<label for="creteria_2"><b><?php esc_html_e("Critera 2 Score", 'arcane') ?></b></label>
...
<p>
<label for="Critera_1"><b><?php esc_html_e("Critera 3", 'arcane') ?></b></label>
<input type="text" name="creteria_3_text" id="creteria_3_text" value="<?php echo esc_attr($creteria_3_text); ?>" />
</p>
<p>
<label for="creteria_3"><b><?php esc_html_e("Critera 3 Score", 'arcane') ?></b></label>
...
<p>
<label for="creteria_4_text"><b><?php esc_html_e("Critera 4", 'arcane') ?></b></label>
<input type="text" name="creteria_4_text" id="creteria_4_text" value="<?php echo esc_attr($creteria_4_text); ?>" />
</p>
<p>
<label for="creteria_4"><b><?php esc_html_e("Critera 4 Score", 'arcane') ?></b></label>
...
<p>
<label for="creteria_5_text"><b><?php esc_html_e("Critera 5", 'arcane') ?></b></label>
<input type="text" name="creteria_5_text" id="creteria_5_text" value="<?php echo esc_attr($creteria_5_text); ?>" />
</p>
<p>
<label for="creteria_5"><b><?php esc_html_e("Critera 5 Score", 'arcane') ?></b></label>
...
add_action( 'save_post', 'arcane_meta_box_save' );
function arcane_meta_box_save( $post_id )
{
