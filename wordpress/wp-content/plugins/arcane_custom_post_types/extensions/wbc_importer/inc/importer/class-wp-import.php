...
class WP_Import extends WP_Importer {
	...
	function import( $file ) {
		...
		if(count($result) == 0)
		{
			$wpdb->query( $wpdb->prepare("INSERT INTO $games (`id`, `title`, `abbr`, `icon`, `g_banner_file`) VALUES 
          ( %d, %s, %s, %d, %d),
          ( %d, %s, %s, %d, %d),
          ( %d, %s, %s, %d, %d),
          ( %d, %s, %s, %d, %d),
          ...
          ( %d, %s, %s, %d, %d),
          ( %d, %s, %s, %d, %d)",
				1, 'Rainbow 6 Siege', 'R6', 73154, 73277,
				2, 'COD: Cold War', 'COD', 73155, 1983,
				3, 'League of Legends', 'LoL', 73156, 1985,
				4, 'Overwatch', 'OW', 73157, 1987,
				5, 'Valorant', 'Valorant', 73158, 1989,
				6, 'Dota 2', 'Dota 2', 73159, 1991,
				7, 'Counter Strike: GO', 'CS:GO', 73160, 1993,
				8, 'Apex', 'Apex', 73153, 73149));
		...
		if(count($result) == 0)
		{
          ...
          ( %d, %d, %s, %d),( %d, %d, %s, %d)",
				...
				5, 2, 'Ruka', 1998,
				6, 2, 'Armada', 1999,
				7, 3, 'Summoner\'s Rift', 2000,
				8, 6, 'Defense of the Ancients', 2001,
				9, 4, 'Busan', 2002,
				10, 4, 'Rialto', 2003,
				11, 4, 'Castillo', 2004,
				12, 4, 'Havana', 2005,
